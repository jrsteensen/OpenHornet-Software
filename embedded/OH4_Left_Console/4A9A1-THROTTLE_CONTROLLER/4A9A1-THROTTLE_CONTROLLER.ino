...
* CAGE_UNCAGE, SPEEDBRAKE_RETRACT, SPEEDBRAKE_EXTEND, COUNTERMEASURES_AFT, COUNTERMEASURES_FWD, D, C, B, A, PUSH, JOY_SW, JOY_X, JOY_Y, ANTENNA_ELEVATION
*
*/
#define CAGE_UNCAGE 0
#define SPEEDBRAKE_RETRACT 1
#define SPEEDBRAKE_EXTEND 2
