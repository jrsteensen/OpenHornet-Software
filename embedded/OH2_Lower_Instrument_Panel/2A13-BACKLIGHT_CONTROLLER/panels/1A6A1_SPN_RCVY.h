 ...
 *            - An array with the LEDs and their roles (LED_INSTR_BL, LED_SPIN)
...
public:
    /**
     * @brief Gets the singleton instance of the SpnRcvyPanel class
...
private:
    ...
    /**
     * @brief Callback for SPIN indicator
     * @param newValue The new state of the indicator (0 or 1)
     * @see This method is called by DCS-BIOS when the SPIN indicator state changes
     */
